...
export default function InputText({ error, size, disabled, className, icon, ...props }: InputTextProps) {
    return (
        <div className={inputTextContainerVariants({ className })}>
            <div className={inputTextWrapperVariants({ size, disabled })}>
                ...
                <input type="text" className={inputTextVariants()} disabled={disabled as boolean} {...props} />
            </div>
